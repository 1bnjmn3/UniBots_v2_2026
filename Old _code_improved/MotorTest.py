...
def main(): 
    print("Test front left")
    for i in range(0, 1000000): 
        _set_side(motor_fl, 50)
    print("Test front right")
    for i in range(0, 1000000):
        _set_side(motor_fr, 50)
    print("Test back left")
    for i in range(0, 10000000):
        _set_side(motor_rl, 50)
    print("Test back right")
    for i in range(0, 10000000):
        _set_side(motor_rr, 50)
